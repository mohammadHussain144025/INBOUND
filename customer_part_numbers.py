...
import shutil
import gnupg
from setup import envFile, file_mapping_customer_part_number
...
def check_and_download_file(sftp):
    ...
    try:
        ...
        for region, filename_prefix in file_mapping_customer_part_number.items():
